    ...
    public class HuaTuoEditorHelper
    {
        ...
        private static void BuildAssetBundles(string tempDir, string outputDir, BuildTarget target)
        {
            ...
            foreach(var dll in hotfixDlls)
            {
                ...
                script.Add(dllBytesPath);
            }

            List<AssetBundleBuild> abs = new List<AssetBundleBuild>();
            AssetBundleBuild scriptAb = new AssetBundleBuild
            {
                assetBundleName = "script",
                assetNames = script.Select(s => ToReleateAssetPath(s)).ToArray(),
            };
            abs.Add(scriptAb);


            List<string> prefabList = new List<string>();
            string testPrefab = $"{Application.dataPath}/Arts/prefab/GameFramework_start.prefab";
            prefabList.Add(testPrefab);
            AssetDatabase.Refresh(ImportAssetOptions.ForceUpdate);



            List<AssetBundleBuild> prefabAbs = new List<AssetBundleBuild>();
            AssetBundleBuild prefabAb = new AssetBundleBuild
            {
                assetBundleName = "prefab",
                assetNames = prefabList.Select(s => ToReleateAssetPath(s)).ToArray(),
            };
            abs.Add(prefabAb);
