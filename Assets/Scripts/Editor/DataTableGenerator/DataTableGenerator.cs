...
namespace StarForce.Editor.DataTableTools
{
    ...
    {
        private const string DataTablePath = "Assets/Sources/DataTables";
        private const string CSharpCodePath = "Assets/Sources/Scripts/DataTable";
        private const string CSharpCodeTemplateFileName = "Assets/Sources/Configs/DataTableCodeTemplate.txt";
